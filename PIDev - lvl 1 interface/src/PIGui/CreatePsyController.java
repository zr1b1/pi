...
public class CreatePsyController implements Initializable {
    ...
    private void ajouter_psy(ActionEvent event) throws IOException 
    {
        ...
        sp.Ajouter(new psycho ((Integer.parseInt(tfId.getText())), tfUsername.getText(), tfPassword.getText(), tfMail.getText(), java.sql.Date.valueOf((tfDate.getValue())), tfCode.getText()) ) ;
        
        JOptionPane.showMessageDialog(null,"Psychologist added");
