...
public class ModifProfilPsyController implements Initializable {
    ...
    private void update(ActionEvent event) throws IOException 
    {
        ...
        sp.Modifier(new psycho ((Integer.parseInt(tfIdU.getText())), tfUsernameU.getText(), tfPasswordU.getText(), tfMailU.getText(), java.sql.Date.valueOf((tfDateU.getValue())), tfCodeU.getText() ));
